...
function App() {
  ...
  return (
    <div className='container'>
      ...
      {/* <div className='selected-catagory-container'>
        <p className='selected-catagory-para'>Selected Catagory: {searchInput? searchInput.current.value : "please select a catagory"}</p>
      </div> */}
